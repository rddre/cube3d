...
/*   Updated: 2025/12/07 01:44:58 by asaracut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void rotation(int direction, t_cub *cub)
{
    ...
    angle = (direction == 1) ? ROT_SPEED : -ROT_SPEED; // use macro
    cos_a = cos(angle);
    sin_a = sin(angle);
    ...
    cub->player.plane_x = cub->player.plane_x * cos_a - cub->player.plane_y * sin_a;
